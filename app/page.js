      ...
      <main className="isolate relative z-0">
        ...
        <div className="relative overflow-hidden">
          ...
          >
            ...
            <div className="absolute left-[40%] top-[30%] w-[45%] h-[40%] rounded-full opacity-14 blur-[90px]" style={{ background: "radial-gradient(ellipse at center, rgba(217,70,239,0.8) 0%, rgba(249,168,212,0.4) 50%, transparent 80%)" }} />
